  ...
  return (
    <div>
      ...
      <div className="space-y-8">
        <div className="border-b border-gray-200 pb-6">
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
              <li>
                <a href="https://doi.org/10.1016/j.cpet.2025.09.003"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="text-primary hover:underline">
                  Toward Integrated Clinical-Computational Nuclear Medicine (PET Clinics, 2026)
                </a>
              </li>
              <li>
                <a href="https://doi.org/10.1016/j.cpet.2021.06.006"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="text-primary hover:underline">
        ...
        <div className="border-b border-gray-200 pb-6">
          <h2 className="text-2xl font-bold mb-3">Patient Health Timelines & Foundation Models</h2>
          <p className="text-gray-700 mb-4">
            Developing patient health timeline models, including ETHOS, for personalized decision support in the context of 4P medicine
            (Predictive, Preventive, Personalized, and Participatory). We study quantitative world
            models of clinical trajectories and how foundation models can support individualized
            risk estimation and clinical decision-making.
          </p>
          <div className="mt-4">
            <p className="text-sm font-semibold text-gray-600 mb-2">Related Publications:</p>
            <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
              <li>
                <a href="https://doi.org/10.1016/j.landig.2026.101011">Beyond language: generative artificial intelligence as a general computing model for medicine (The Lancet Digital Health, 2026)</a>
              </li>
              <li>
                <a href="https://doi.org/10.1056/AIra2501253">MEDS — An Emerging Data Standard and Ecosystem for Health AI Research (NEJM AI, 2026)</a>
              </li>
              <li>
        ...
        <div className="border-b border-gray-200 pb-6">
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-gray-700">
              <li>
                <a href="https://www.routledge.com/Statistical-Computing-in-Nuclear-Imaging/Sitek/p/book/9781439849347"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="text-primary hover:underline">
